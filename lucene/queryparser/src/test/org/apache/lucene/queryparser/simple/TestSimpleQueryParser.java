...
import static org.apache.lucene.queryparser.simple.SimpleQueryParser.FUZZINESS_OPERATOR;
...
import static org.apache.lucene.queryparser.simple.SimpleQueryParser.SLOP_OPERATOR;
...
public class TestSimpleQueryParser extends LuceneTestCase {
  ...
  public void testDisableFuzziness() {
    ...
    assertEquals(expected, parseKeyword("foo~1", ~FUZZINESS_OPERATOR));
  }
  ...
  public void testDisableSlop() {
    ...
    assertEquals(expected, parse("\"foo bar\"~2", ~SLOP_OPERATOR));
  }
